...
export const createSslNamespace = (client: PorkbunClient) => {
	...
	return {
		 ...
		 */
		getSslBundle(payload: RetrieveSslBundlePayload): Promise<RetrieveSslBundleResponse> {
			return client.request<RetrieveSslBundleResponse>(`${BASE_PATH}/retrieve/${payload.domain}`)
		},
	}
}